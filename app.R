# options(browser = "C:\\my_shiny_app\\GoogleChromePortable\\App\\Chrome-bin\\chrome.exe")
    ...
    fluidRow(
      box(title = "Table",
          ...
          tabBox(
            ...
            tabPanel("What is a valid data frame",
                     "A valid data set has class data.frame.", br(),
                     "It will have a column for the dependent variable", br(),
